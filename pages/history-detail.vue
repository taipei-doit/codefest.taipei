...
const currentActivity = computed(() => {
  const activities = tm(`history.activities.${type}`);
  ...
  <div>
    <header class="bg-black p-5 pb-0">
      <div class="container mx-auto border border-white h-full flex flex-col">
        <div class="m-1 border border-white flex-1 px-10 relative">
          <NuxtLink
            to="/history"
            class="px-4 flex space-x-2 absolute left-0 top-1/2 -translate-y-1/2"
            tabindex="0"
          >
            <img
